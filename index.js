...
app.get('/res/weather/01d.png', (req, res) => res.sendFile(__dirname + '/res/weather/01d.png'));
app.get('/res/weather/01n.png', (req, res) => res.sendFile(__dirname + '/res/weather/01n.png'));
app.get('/res/weather/02d.png', (req, res) => res.sendFile(__dirname + '/res/weather/02d.png'));
app.get('/res/weather/02n.png', (req, res) => res.sendFile(__dirname + '/res/weather/02n.png'));
app.get('/res/weather/03d.png', (req, res) => res.sendFile(__dirname + '/res/weather/03d.png'));
app.get('/res/weather/03n.png', (req, res) => res.sendFile(__dirname + '/res/weather/03n.png'));
app.get('/res/weather/04d.png', (req, res) => res.sendFile(__dirname + '/res/weather/04d.png'));
app.get('/res/weather/04n.png', (req, res) => res.sendFile(__dirname + '/res/weather/04n.png'));
app.get('/res/weather/09d.png', (req, res) => res.sendFile(__dirname + '/res/weather/09d.png'));
app.get('/res/weather/09n.png', (req, res) => res.sendFile(__dirname + '/res/weather/09n.png'));
app.get('/res/weather/10d.png', (req, res) => res.sendFile(__dirname + '/res/weather/10d.png'));
app.get('/res/weather/10n.png', (req, res) => res.sendFile(__dirname + '/res/weather/10n.png'));
app.get('/res/weather/11d.png', (req, res) => res.sendFile(__dirname + '/res/weather/11d.png'));
app.get('/res/weather/11n.png', (req, res) => res.sendFile(__dirname + '/res/weather/11n.png'));
app.get('/res/weather/13d.png', (req, res) => res.sendFile(__dirname + '/res/weather/13d.png'));
app.get('/res/weather/13n.png', (req, res) => res.sendFile(__dirname + '/res/weather/13n.png'));
app.get('/res/weather/50d.png', (req, res) => res.sendFile(__dirname + '/res/weather/50d.png'));
app.get('/res/weather/50n.png', (req, res) => res.sendFile(__dirname + '/res/weather/50n.png'));